...
<body class="bg-[#f8f9fa] text-gray-900 font-sans antialiased flex h-screen overflow-hidden">

    <!-- Sidebar -->
    <aside class="w-[280px] bg-white border-r border-gray-200 flex flex-col justify-between flex-shrink-0 z-20">
        <div>
            <!-- Logo -->
            <div class="h-[80px] flex items-center px-8 border-b border-gray-200">
                <a href="/admin" class="flex items-center gap-2">
                    ...
                    <span class="font-bold text-xl tracking-tight text-gray-900">TICKETER.<span class="text-black font-black">ADMIN</span></span>
                </a>
            </div>
    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden">
        <!-- Topbar -->
        <header class="h-[80px] bg-white border-b border-gray-200 flex items-center justify-between px-8 flex-shrink-0 z-10">
            <h1 class="text-lg font-bold text-gray-900">{{ $title ?? 'Dashboard' }}</h1>
            
            <div class="flex items-center gap-4">
                <!-- Status Badge -->
                <div class="px-4 py-1.5 rounded-full bg-green-50 border border-green-200 text-green-600 text-xs font-semibold flex items-center gap-2">
                    Sistem Daring
                </div>
